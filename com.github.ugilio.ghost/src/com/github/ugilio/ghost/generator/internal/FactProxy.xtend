...
import com.github.ugilio.ghost.ghost.InitConstrType
import it.cnr.istc.timeline.lang.InstantiatedValue

class FactProxy extends ProxyObject implements Fact {
	com.github.ugilio.ghost.ghost.FactGoal real;
	Interval start;
	Interval duration;
	Interval end;

	new(com.github.ugilio.ghost.ghost.FactGoal real, Register register) {
		super(register);
		this.real = real;
	}
